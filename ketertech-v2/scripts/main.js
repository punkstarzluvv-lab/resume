...
function initMobileMenu() {
    ...
    if (toggleBtn && overlay && !toggleBtn.dataset.init) {
        ...
        // Close menu when clicking outside the nav content (on the blurred background)
        ...
        const links = overlay.querySelectorAll('.placeholder-btn');
        links.forEach(link => {
